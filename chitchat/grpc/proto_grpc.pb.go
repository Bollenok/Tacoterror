...
const (
	ChitChat_Chat_FullMethodName = "/chitchat.v1.ChitChat/Chat"
)
...
func (c *chitChatClient) Chat(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ClientMessage, ServerMessage], error) {
...
type ChitChat_ChatClient = grpc.BidiStreamingClient[ClientMessage, ServerMessage]
...
func (UnimplementedChitChatServer) Chat(grpc.BidiStreamingServer[ClientMessage, ServerMessage]) error {
...
func _ChitChat_Chat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ChitChatServer).Chat(&grpc.GenericServerStream[ClientMessage, ServerMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChitChat_ChatServer = grpc.BidiStreamingServer[ClientMessage, ServerMessage]
...
var ChitChat_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chitchat.v1.ChitChat",
	...
	Metadata: "chitchat/grpc/proto.proto",
}
